...
public final class NeutronUtils {
    ...
    public static class FwProtocolMapper {
        ...
        private static final ImmutableBiMap<String, Class<? extends FwProtocolBase>> MAPPER = new ImmutableBiMap.Builder<String, Class<? extends FwProtocolBase>> ().put ("tcp", FwProtocolTcp.class).put ("udp", FwProtocolUdp.class).put ("icmp", FwProtocolIcmp.class).build ();
    ...
    public static class ProtocolMapper {
        ...
        private static final ImmutableBiMap<String, Class<? extends ProtocolBase>> MAPPER = new ImmutableBiMap.Builder<String, Class<? extends ProtocolBase>> ().put ("icmp", ProtocolIcmp.class).put ("tcp", ProtocolTcp.class).put ("udp", ProtocolUdp.class).put ("icmpv6", ProtocolIcmpV6.class).build ();
    ...
    public static class DirectionMapper {
        ...
        private static final ImmutableBiMap<String, Class<? extends DirectionBase>> MAPPER = 
            new ImmutableBiMap.Builder<String, Class<? extends DirectionBase>> ().put ("egress", DirectionEgress.class).put ("ingress", DirectionIngress.class).build ();

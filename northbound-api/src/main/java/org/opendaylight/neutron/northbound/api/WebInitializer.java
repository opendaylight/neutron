...
public class WebInitializer {
    ...
    @Inject
    public WebInitializer(@OsgiService WebServer webServer, @OsgiService WebContextSecurer webContextSecurer,
            @OsgiService ServletSupport servletSupport, NeutronNorthboundRSApplication app) throws ServletException {

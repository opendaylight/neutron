...
public class NeutronMeteringLabelsNorthbound {
    ...
    public Response listMeteringLabels(
        ...
        INeutronMeteringLabelCRUD routerInterface = NeutronCRUDInterfaces.getINeutronMeteringLabelCRUD(this);
        if (routerInterface == null) {
            throw new ServiceUnavailableException("NeutronMeteringLabel CRUD Interface "
                    + RestMessages.SERVICEUNAVAILABLE.toString());
        }
        List<NeutronMeteringLabel> allNeutronMeteringLabels = routerInterface.getAllNeutronMeteringLabels();
    ...
    public Response createMeteringLabel(final NeutronMeteringLabelRequest input) {
        ...
        if (input.isSingleton()) {
             ...
             * exists and has been designated as "meteringLabel:external"
             */

...
public class NeutronLoadBalancerPoolMembersNorthbound {
    ...
    private static final String INTERFACE_NAME = "LoadBalancerPoolMember CRUD Interface";
    private static final String UUID_NO_EXIST = "LoadBalancerPoolMember UUID does not exist.";
    ...
    private NeutronCRUDInterfaces getNeutronInterfaces() {
        NeutronCRUDInterfaces answer = new NeutronCRUDInterfaces().fetchINeutronLoadBalancerPoolMemberCRUD(this);

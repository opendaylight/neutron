...
public class PortStatusUpdateInitializer {
    ...
    private void dataChangeEventSubscription() {
        try {
            ...
            LOG.info("PortStatusUpdateInitializer: create-data-change-event-subscription returned {}", res.toString());
        } catch (OperationFailedException e) {
            LOG.warn("PortStatusUpdateInitializer: exception while calling create-data-change-event-subscription", e);
        }
    }
    ...
    private void streamSubscribe() {
        ...
        try {
            ...
            LOG.info("PortStatusUpdateInitializer: subscribeToStream returned {}", res.toString());
        } catch (OperationFailedException e) {
            LOG.warn("PortStatusUpdateInitializer: exception while calling subscribeToStream", e);
        }
    }
}

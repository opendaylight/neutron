...
public class NeutronVPNIPSECPoliciesNorthbound {
    ...
    public Response createVPNIPSECPolicy(final NeutronVPNIPSECPolicyRequest input) {
        INeutronVPNIPSECPolicyCRUD ikePolicyInterface = NeutronCRUDInterfaces.getINeutronVPNIPSECPolicyCRUD(this);
        ...
        if (input.isSingleton()) {
             ...
             */
            if (ikePolicyInterface.neutronVPNIPSECPolicyExists(singleton.getID()))
             ...
             */
            ikePolicyInterface.addNeutronVPNIPSECPolicy(singleton);
            if (instances != null) {
                for (Object instance : instances) {
                    INeutronVPNIPSECPolicyAware service = (INeutronVPNIPSECPolicyAware) instance;
    ...
    public Response updateVPNIPSECPolicy(
         ...
         */
        if (!ikePolicyInterface.neutronVPNIPSECPolicyExists(policyUUID))
            throw new ResourceNotFoundException("VPNIPSECPolicy UUID not found");
        if (!input.isSingleton())
            throw new BadRequestException("Only single ikePolicy deltas supported");
        NeutronVPNIPSECPolicy singleton = input.getSingleton();
        NeutronVPNIPSECPolicy original = ikePolicyInterface.getNeutronVPNIPSECPolicy(policyUUID);
         ...
         */
        ikePolicyInterface.updateNeutronVPNIPSECPolicy(policyUUID, singleton);
        NeutronVPNIPSECPolicy updatedVPNIPSECPolicy = ikePolicyInterface.getNeutronVPNIPSECPolicy(policyUUID);
        if (instances != null) {
            for (Object instance : instances) {
                INeutronVPNIPSECPolicyAware service = (INeutronVPNIPSECPolicyAware) instance;
        ...
        return Response.status(200).entity(
                new NeutronVPNIPSECPolicyRequest(ikePolicyInterface.getNeutronVPNIPSECPolicy(policyUUID))).build();
    }

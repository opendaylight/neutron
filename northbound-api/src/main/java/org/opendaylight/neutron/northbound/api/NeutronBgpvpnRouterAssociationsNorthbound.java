...
public class NeutronBgpvpnRouterAssociationsNorthbound extends AbstractNeutronNorthbound<NeutronBgpvpnRouterAssociation,
    ...
    public NeutronBgpvpnRouterAssociationsNorthbound(INeutronBgpvpnRouterAssociationCRUD neutronCRUD) {
        super(neutronCRUD);
    }
    ...
    public Response listBgpvpnRouterAssociations(
        ...
        INeutronBgpvpnRouterAssociationCRUD bgpvpnRouterAssoInterface = getNeutronCRUD();

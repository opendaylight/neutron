...
public final class NeutronTapFlowNorthbound
    ...
    public Response listGroups(
            ...
            @QueryParam("status") String queryTapFlowStatus,
            // pagination
        ...
        for (NeutronTapFlow nsg : tapFlowInterface.getAll()) {
            if ((queryTapFlowUUID == null || queryTapFlowUUID.equals(nsg.getID()))
                    ...
                    && (queryTapFlowStatus == null || queryTapFlowStatus.equals(nsg.getTapFlowStatus()))
...
>>>>>>> 5b6495f... Added Tap-As-A-Service implementation in Neutron.
    @GET
    @Produces({ MediaType.APPLICATION_JSON })
    @StatusCodes({ @ResponseCode(code = HttpURLConnection.HTTP_OK, condition = "Operation successful"),
            @ResponseCode(code = HttpURLConnection.HTTP_UNAUTHORIZED, condition = "Unauthorized"),
            ...
            @ResponseCode(code = HttpURLConnection.HTTP_UNAVAILABLE, condition = "No providers available") })
<<<<<<< HEAD
    public Response showTapFlow(@PathParam("tapFlowUUID") String tapFlowUUID,
            @QueryParam("fields") List<String> fields) {
        return show(tapFlowUUID, fields);
    }
    ...
    @StatusCodes({ @ResponseCode(code = HttpURLConnection.HTTP_CREATED, condition = "Created"),
            @ResponseCode(code = HttpURLConnection.HTTP_UNAVAILABLE, condition = "No providers available") })
    public Response createTapFlow(final NeutronTapFlowRequest input) {
        return create(input);
=======
...
>>>>>>> 5b6495f... Added Tap-As-A-Service implementation in Neutron.
    ...
    @StatusCodes({ @ResponseCode(code = HttpURLConnection.HTTP_OK, condition = "Operation successful"),
            ...
            @ResponseCode(code = HttpURLConnection.HTTP_UNAVAILABLE, condition = "No providers available") })
<<<<<<< HEAD
    public Response updateTapFlow(@PathParam("tapFlowUUID") String tapFlowUUID,
            final NeutronTapFlowRequest input) {
        return update(tapFlowUUID, input);
=======
...
>>>>>>> 5b6495f... Added Tap-As-A-Service implementation in Neutron.
    ...
    @StatusCodes({ @ResponseCode(code = HttpURLConnection.HTTP_NO_CONTENT, condition = "No Content"),
            ...
            @ResponseCode(code = HttpURLConnection.HTTP_UNAVAILABLE, condition = "No providers available") })
<<<<<<< HEAD
    public Response deleteTapFlow(@PathParam("tapFlowUUID") String tapFlowUUID) {
        return delete(tapFlowUUID);
=======

...
@Path("/qos/policies") public class NeutronQosPolicyNorthbound extends
    ...
    @Override protected NeutronQosPolicy extractFields(NeutronQosPolicy o, List<String> fields) {
        return o.extractFields(fields);
    }

    @Override protected NeutronQosPolicyRequest newNeutronRequest(NeutronQosPolicy o) {
        return new NeutronQosPolicyRequest(o);
    }

    @Override protected INeutronQosPolicyCRUD getNeutronCRUD() {
    ...
    @Path("{qosPolicyUUID}") @PUT @Produces({MediaType.APPLICATION_JSON})

...
public class NeutronL2gatewayConnectionNorthbound {
    ...
    private static final String ID_NO_EXIST = "L2gateway Connection ID does not exist.";
    ...
    public Response createL2gatewayConnection(final NeutronL2gatewayConnectionRequest input) {
        ...
        if (input.isSingleton()) {
            ...
            if (l2gatewayConnectionInterface.neutronL2gatewayConnectionExists(singleton.getID())) {
    ...
    public Response listL2gatewayConnections(
        ...
        List<NeutronL2gatewayConnection> allL2gatewayConnections = l2gatewayConnectionInterface
            .getAllNeutronL2gatewayConnections();
    ...
    public Response showL2gatewayID(@PathParam("l2gatewayConnectionID") String l2gatewayConnectionID,
        ...
        if (!l2gatewayConnectionInterface
            .neutronL2gatewayConnectionExists(l2gatewayConnectionID)) {
            throw new ResourceNotFoundException(ID_NO_EXIST);
        }
        if (!fields.isEmpty()) {
            NeutronL2gatewayConnection ans = l2gatewayConnectionInterface
                .getNeutronL2gatewayConnection(l2gatewayConnectionID);
            return Response
            ...
            return Response.status(HttpURLConnection.HTTP_OK)
                .entity(new NeutronL2gatewayConnectionRequest(l2gatewayConnectionInterface
                       .getNeutronL2gatewayConnection(l2gatewayConnectionID))).build();
    }
    ...
    public Response deleteL2gatewayConnection(
        ...
        if (!l2gatewayConnectionInterface.removeNeutronL2gatewayConnection(l2gatewayConnectionID)){
    ...
    /**
     * Update a L2gateway Connection
     *  Neutron l2gateway connection API doesn't support update.
     */
}
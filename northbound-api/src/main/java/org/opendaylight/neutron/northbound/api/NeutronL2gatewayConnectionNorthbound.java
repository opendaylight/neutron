...
public class NeutronL2gatewayConnectionNorthbound {
    ...
    public Response createL2gatewayConnection(final NeutronL2gatewayConnectionRequest input) {
        ...
        if (input.isSingleton()) {
            ...
            if (l2gatewayConnectionInterface.exists(singleton.getID())) {
            ...
            l2gatewayConnectionInterface.add(singleton);
     ...
     * @param fields
     * @param queryTenantID
     * @param queryConnectionID
     * @param queryL2gatewayID
     * @param queryNetworkID
     * @param querySegmentID
     * @param queryPortID
     * @param limit
     * @param marker
     * @param pageReverse
        ...
        if (!fields.isEmpty()) {
            ...
            return Response.status(HttpURLConnection.HTTP_OK)
                .entity(new NeutronL2gatewayConnectionRequest(l2gatewayConnectionInterface
                       .get(l2gatewayConnectionID))).build();
    }
    ...
    public Response deleteL2gatewayConnection(
        ...
        if (!l2gatewayConnectionInterface.remove(l2gatewayConnectionID)){

...
public final class NeutronBgpvpnsNorthbound
    ...
    public Response deleteBgpvpn(@PathParam("bgpvpnUUID") String bgpvpnUUID) {
        ...
        NeutronBgpvpnNetworkAssociationsNorthbound netAssoNorthBound = new NeutronBgpvpnNetworkAssociationsNorthbound(this.bgpvpnNetAssoInterface);
        ...
        NeutronBgpvpnRouterAssociationsNorthbound routeAssoNorthBound = new NeutronBgpvpnRouterAssociationsNorthbound(bgpvpnRouterAssoInterface);

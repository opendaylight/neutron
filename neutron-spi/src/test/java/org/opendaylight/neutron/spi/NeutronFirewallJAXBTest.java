...
public class NeutronFirewallJAXBTest {
    ...
    public void test_NeutronFirewall_JAXB() {
        ...
        try {
            ...
            Assert.assertEquals("NeutronFirewall JAXB Test 5: Testing admin_state_up failed",
                  false, testObject.getFirewallAdminStateIsUp());

            Assert.assertEquals("NeutronFirewall JAXB Test 6: Testing status failed",
                  "DOWN", testObject.getFirewallStatus());

            Assert.assertEquals("NeutronFirewall JAXB Test 7: Testing shared failed",
                  true, testObject.getFirewallIsShared());
    ...
    public void test_NeutronFirewallPolicy_JAXB() {
        ...
        try {
            ...
            Assert.assertEquals("NeutronFirewallPolicy JAXB Test 5: Testing shared failed",
                  true, testObject.getFirewallPolicyIsShared());

            Assert.assertEquals("NeutronFirewallPolicy JAXB Test 6: Testing audited failed",
                  true, testObject.getFirewallPolicyIsAudited());
    ...
    public void test_NeutronFirewallRule_JAXB() {
        ...
        try {
            ...
            Assert.assertEquals("NeutronFirewallRule JAXB Test 6: Testing shared failed",
                  false, testObject.getFirewallRuleIsShared());
            ...
            Assert.assertEquals("NeutronFirewallRule JAXB Test 15: Testing enabled failed",
                  true, testObject.getFirewallRuleIsEnabled());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

...
public class NeutronSubnet_IPAllocationPoolTest {
    ...
    public void containsTest() {
        ...
        Assert.assertEquals("Contains Test 1: address one below pool start failed",
              false, apUT.contains("10.18.0.1"));

        Assert.assertEquals("Contains Test 2: address == pool start failed",
              true, apUT.contains("10.18.0.2"));

        Assert.assertEquals("Contains Test 3: adress in pool failed",
              true, apUT.contains("10.18.0.3"));

        Assert.assertEquals("Contains Test 4: address == pool end failed",
              true, apUT.contains("10.18.0.4"));

        Assert.assertEquals("Contains Test 5: one above pool end failed",
              false, apUT.contains("10.18.0.5"));
    }

...
public class NeutronQosJAXBTest {
    ...
    private static final String NeutronQosPolicy_sourceJson =
        "{" + "\"id\": \"d6220bbb-35f3-48ab-8eae-69c60aef3546\","
            ...
            + "\"tenant_id\": \"aa902936679e4ea29bfe1158e3450a14\"," + "\"max_kbps\": 15, "
            + "\"max_burst_kbps\": 25 } ],"
    ...
    @Test
    public void test_NeutronQosPolicy_JAXB() {
        ...
        try {
            ...
            Assert.assertEquals(
                ...
                new BigInteger("15"), bwPolicyRules.get(0).maxKbps);

            Assert
                .assertEquals("NeutronQosPolicy JaxB Test 6.4 : Testing Maximum Burst value failed",
                    new BigInteger("25"), bwPolicyRules.get(0).maxBurstKbps);

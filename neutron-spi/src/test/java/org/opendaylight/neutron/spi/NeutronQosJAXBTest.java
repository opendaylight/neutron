...
public class NeutronQosJAXBTest {
    ...
    public void test_NeutronQosPolicy_JAXB() throws JAXBException {
        ...
        Assert.assertEquals(
            "NeutronQosPolicy JAXB Test 5.0: Testing Bandwidth Policy length failed",
                1, bwPolicyRules.size());
        ...
        Assert.assertEquals(
            "NeutronQosPolicy JAXB Test 6.0: Testing Bandwidth Policy length failed",
                1, dscpPolicyRules.size());

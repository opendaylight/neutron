...
public class NeutronQosBandwidthRule extends NeutronObject implements Serializable, INeutronObject {
    ...
    public BigInteger getBandwidthMaxKbpsValue() {
        return maxKbps;
    }

    public void setBandwidthMaxValue(BigInteger qosBandwidthMaxValue) {
        this.maxKbps = qosBandwidthMaxValue;
    }

    public BigInteger getBandwidthMaxBurstKbps() {
        return maxBurstKbps;
    }

    public void setBandwidthMaxBurst(BigInteger qosBandwidthMaxBurst) {
        this.maxBurstKbps = qosBandwidthMaxBurst;
    }
    ...
    public NeutronQosBandwidthRule extractFields(List<String> fields) {
        ...
        while (i.hasNext()) {
            ...
            if (s.equals("max_kbps")) {
                ans.setBandwidthMaxValue(this.getBandwidthMaxKbpsValue());
            }
            if (s.equals("max_burst_kbps")) {
                ans.setBandwidthMaxBurst(this.getBandwidthMaxBurstKbps());
            }
        }
        return ans;
    }

...
public interface INeutronQosPolicyCRUD extends INeutronCRUD<NeutronQosPolicy> {
     ...
     *
     * @param uuid UUID of the Qos Policy object
     * @return boolean
     */
     ...
     * concurrent map
     *
     * @param uuid identifier for the Qos Policy object
     ...
     *
     * @param uuid  identifier of the Qos Policy object
     * @param delta OpenStackQosPolicy object containing changes to apply

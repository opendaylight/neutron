...
public class NeutronNetworkTests {
    ...
    public void network_collection_wait_for_start() {
    ...
    public void network_collection_get_test(){
        String url_s=base + "/networks";
        ITNeutronE2E.test_fetch(url_s, true ,"Network Element Get Failed");
    }
    ...
    public static void runTests(String base) {
        ...
        network_tester.network_collection_wait_for_start();

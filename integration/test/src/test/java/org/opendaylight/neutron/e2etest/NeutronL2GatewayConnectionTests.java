...
public class NeutronL2GatewayConnectionTests {
    ...
    public void l2gateway_connection_modify_test() {
        String url = base + "/l2gateway-connections/3b0ef8f4-82c7-44d4-a4fb-6177f9a21977";
        String content = " { \"l2gateway_connection\": { \"port_id\": \"9ea656c7c9b8447494f33b0bc741d9a9\"," +
            "\"gateway_id\": \"d3590f37-b072-4358-9719-71964d84a31c\", \"segmentation_id\": 50," +
            "\"network_id\": \"c69933c1-b472-44f9-8226-30dc4ffd454c\"," +
            "\"id\": \"3b0ef8f4-82c7-44d4-a4fb-6177f9a21977\"," +
            "\"tenant_id\": \"45977fa2dbd7482098dd68d0d8970117\" } }";
        ITNeutronE2E.test_modify(url, content, "L2 Gateway Connection Singleton Put Failed");
    }
    ...
    public static void runTests(String base) {
        ...
        l2gateway_connection_tester.l2gateway_connection_modify_test();

...
public class NeutronHostconfigVppListener implements ClusteredDataTreeChangeListener<Node> {
    ...
    private static final QName V3PO_1704_CAPABILITY = QName.create(URI.create("urn:opendaylight:params:xml:ns:yang:v3po"),
            NeutronHostconfigUtils.parseDate("2017-03-15"), "v3po");
    private static final QName V3PO_1701_CAPABILITY = QName.create(URI.create("urn:opendaylight:params:xml:ns:yang:v3po"),

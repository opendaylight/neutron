...
public class NeutronFirewallRuleInterface extends AbstractNeutronInterface<FirewallRule, FirewallRules, NeutronFirewallRule> implements INeutronFirewallRuleCRUD {
    ...
    protected NeutronFirewallRule fromMd(FirewallRule rule) {
        ...
        if (rule.getProtocol() != null) {
            Protocol protocol = rule.getProtocol();
        ...
        if (rule.getSourcePortRangeMin() != null) {
            answer.setFirewallRuleSrcPortRangeMin(rule.getSourcePortRangeMin().intValue());
        }
        if (rule.getSourcePortRangeMax() != null) {
            answer.setFirewallRuleSrcPortRangeMax(rule.getSourcePortRangeMax().intValue());
        }
        if (rule.getDestinationPortRangeMin() != null) {
            answer.setFirewallRuleDstPortRangeMin(rule.getDestinationPortRangeMin().intValue());
        }
        if (rule.getDestinationPortRangeMax() != null) {
            answer.setFirewallRuleDstPortRangeMax(rule.getDestinationPortRangeMax().intValue());
        }
    ...
    protected FirewallRule toMd(NeutronFirewallRule rule) {
        ...
        if (rule.getFirewallRuleProtocol() != null) {
            String protocolString = rule.getFirewallRuleProtocol();
            Protocol protocol = new Protocol(protocolString.toCharArray());
            ruleBuilder.setProtocol(protocol);
        }
        if (rule.getFirewallRuleIpVer() != null) {
            ImmutableBiMap<Integer, Class<? extends IpVersionBase>> mapper = IP_VERSION_MAP.inverse();
            ruleBuilder.setIpVersion(mapper.get(rule.getFirewallRuleIpVer()));
        }
        if (rule.getFirewallRuleSrcIpAddr() != null) {
            IpPrefixOrAddress ipAddress = new IpPrefixOrAddress(rule.getFirewallRuleSrcIpAddr().toCharArray());
            ruleBuilder.setSourceIpAddr(ipAddress);
        }
        if (rule.getFirewallRuleDstIpAddr() != null) {
            IpPrefixOrAddress ipAddress = new IpPrefixOrAddress(rule.getFirewallRuleDstIpAddr().toCharArray());
            ruleBuilder.setDestinationIpAddr(ipAddress);
        }
        if (rule.getFirewallRuleSrcPortRangeMin() != null) {
            ruleBuilder.setSourcePortRangeMin(rule.getFirewallRuleSrcPortRangeMin().shortValue());
        }
        if (rule.getFirewallRuleSrcPortRangeMax() != null) {
            ruleBuilder.setSourcePortRangeMax(rule.getFirewallRuleSrcPortRangeMax().shortValue());
        }
        if (rule.getFirewallRuleDstPortRangeMin() != null) {
            ruleBuilder.setDestinationPortRangeMin(rule.getFirewallRuleDstPortRangeMin().shortValue());
        }
        if (rule.getFirewallRuleDstPortRangeMax() != null) {
            ruleBuilder.setDestinationPortRangeMax(rule.getFirewallRuleDstPortRangeMax().shortValue());
        }
        ...
        if (rule.getFirewallRuleAction() != null) {
            ImmutableBiMap<String, Class<? extends ActionBase>> mapper = ACTION_MAP.inverse();

...
import org.opendaylight.neutron.utils.hostconfig.NeutronHostconfigUtils;
...
public class NeutronHostconfigVppListener implements ClusteredDataTreeChangeListener<Node> {
    ...
    public NeutronHostconfigVppListener(final DataBroker dataBroker) {
        this.dataBroker = dataBroker;
        this.socketInfo = new SocketInfo("", ""); //TODO
    ...
    public void start() {
        ...
        listenerRegistration = dataBroker.registerDataTreeChangeListener(dataTreeIdentifier,
                NeutronHostconfigVppListener.this);
    }

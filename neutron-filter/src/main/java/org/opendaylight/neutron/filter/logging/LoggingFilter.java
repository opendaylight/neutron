...
@SuppressWarnings("SLF4J_LOGGER_SHOULD_BE_FINAL")
public class LoggingFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain)
        ...
        log.debug("request prefix {}  and request description {}", REQUEST_PREFIX, getRequestDescription(requestWrapper));
        filterChain.doFilter(requestWrapper, responseWrapper);
        log.debug("response prefix {} and response description{}", RESPONSE_PREFIX, getResponseDescription(responseWrapper));
